...
def get_origin_dir(dataset_type=None, dataset_name=None):
    ...
    if system == "Windows":
        ...
        origin_dir = os.path.join(home, "Dataset", "Original_Dataset", dataset_type)
...
def get_cache_dir(dataset_type=None, dataset_name=None):
    ...
    if system == "Windows":
        ...
        cache_dir = os.path.join(home, "Dataset", "Interim_Dataset", dataset_type)
...
def get_export_dir(dataset_type=None, dataset_name=None):
    ...
    if system == "Windows":
        ...
        export_dir = os.path.join(home, "Dataset", "Processed_Dataset", dataset_type)
